...
Assistant:Please brief teh ansert max 5 sentences"""
...
bedrock_embedding = OpenAIEmbeddings()
...
def get_vector_store(docs):
   #storing vector in choramdb
    vectordb = Chroma.from_documents(docs, embedding=bedrock_embedding, persist_directory='./db1')
    vectordb.persist()
